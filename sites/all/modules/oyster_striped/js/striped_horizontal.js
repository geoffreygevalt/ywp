jQuery(document).ready(function($) {	
	...
	var data_height = 100/jQuery('.strip-menu.horizontal').attr('data-count');
	jQuery('.strip-menu.horizontal').attr('data-height', data_height);
	jQuery('.strip-menu.horizontal .strip-item').css({'height': data_height + '%'});				
